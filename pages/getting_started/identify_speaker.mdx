...
![Speaker Clips](/images/speaker-clips.png)

Some of the speakers can be already automatically recognized and named by Jamie. You can edit auto-assigned speaker names or even assign speaker with the contact from People tab. Disabling automatic speaker identification is possible under Preferences tab in Settings.
...
1. Click on the play button to play a short audio clip
2. Listen to the audio clip of each speaker
3. Type the speaker name in the text field
4. You can either create a new speaker or choose one from your **Recent Contacts**

<img
  src="/images/speaker_identification.png"
  alt="Speaker Identification Pn"
  title="Speaker Identification Pn"
  className="mx-auto"
  style={{ width:"57%" }}
/>
...
<Accordion title="Can I edit the speaker after the speaker identification is done?">
  Yes, you can edit a speaker name. Simply click on the speaker again and rename it to the correct name.
</Accordion>