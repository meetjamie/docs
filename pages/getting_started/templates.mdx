...
Custom templates can be shared with everyone in your team.

Open a template, click the **Share** icon in the top right, and set it to **Shared**.

<img
  src="/images/template-sharing.png"
...
<Info>
  Template sharing is only available to users on Team and Enterprise plans.
</Info>
