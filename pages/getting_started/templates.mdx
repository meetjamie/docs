...
Instead of manually choosing a template after every meeting, you can let Jamie pick the right one for you. When auto-apply is enabled for a template, Jamie looks at the meeting and decides if that template is a good fit—and applies it automatically.
...
<Steps>
  ...
  <Step title="Turn on auto-apply">
    Find the **Auto-apply** drop-down and switch it on.

    <img
      src="/images/auto-apply.png"
      alt="Jamie Template Dropdown"
      className="rounded-lg"
      style={{ width:"72%" }}
    />
  </Step>
  <Step title="Repeat for other templates">
