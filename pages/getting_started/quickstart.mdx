...
<AccordionGroup>
  <Accordion title="Create your workspace" defaultOpen={false} icon="seedling">
    ...
    <Info>
      **Please note:** If you are part of a shared workspace, you can store your meeting notes either in a private folder or share them with others in your team.
    </Info>
  </Accordion>
  ...
  <Accordion title="Download Recorder" defaultOpen={false} icon="download">
    ...
    ![](/images/download-recorder-step.png)
  </Accordion>
  ...
  <Accordion title="Summarize your first meeting" defaultOpen={false} icon="chalkboard-user">
    ...
    **How to stop a recording?**
    ...
    ![](/images/stop-recording-icon.png)
