...
<AccordionGroup>
  <Accordion title="Create your account" defaultOpen="false" icon="seedling">
    ...
    To create an account, download the app from https://www.meetjamie.ai/ and sign up with Google, Microsoft, Apple, or your email address. Please follow the onboarding process in the app.
  </Accordion>
