---
title: "Webhooks"
description: "Set up webhooks to customize your workflow with Jamie"
icon: "webhook"
---
...
<Info>
  Note that webhooks operate on a workspace level and will be triggered by meetings from all users once set up.
</Info>
