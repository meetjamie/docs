...
<AccordionGroup>
  <Accordion title="Q1: What output will be shared with others through the URL?">
  ...
  <Accordion title="Q2: Is it possible to only share certain parts of my summary?">
    ...
    When you hover your cursor over the section, a copy symbol will appear. Click on it to copy the content for sharing.
      ...
      <Accordion title="Q3: Can someone access my summary without having the link?">
